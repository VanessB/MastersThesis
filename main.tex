...
\begin{document}
    ...
    \include{parts/introduction.tex} %% Введение.
    \include{parts/theory.tex}       %% Теоретические сведения.
    \include{parts/methods.tex}      %% Разработка численных методов.
    \include{parts/blood.tex}       %% Модель крови.
