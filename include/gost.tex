...
% Отступы.
\setlist[enumerate]{wide=\parindent,noitemsep}
\setlist[itemize]{wide=\parindent,noitemsep}

% Список литературы.
\defbibenvironment{bibliography}{\enumerate[wide=\parindent]}{\endenumerate}{\item}
